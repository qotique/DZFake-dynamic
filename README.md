...
> **Дисклеймер:** Проект создан в образовательных целях для изучения протокола Steam A2S и сетевого программирования на Python. Код не содержит вредоносного (malware) функционала — исходники доступны для аудита. Использование на собственных серверах — на ваше усмотрение и под вашу ответственность.
