...
> **Дисклеймер:** Проект создан в образовательных целях для изучения протокола Steam A2S и сетевого программирования на Python. Использование на собственных серверах — на ваше усмотрение и под вашу ответственность.
